...
load(sprintf("%s/%s/02_Sutherland_2020/18_SAT_ebres_multivariate_Sutherland2020.RData", wdOA,wdOA_output))
...
mul_r = rbind(rA,rE)
####SAVE###
write_csv(AEvc,sprintf("%s/%s/02_Sutherland_2020/22_AE_ebres_multivariate_Sutherland2020_h2.csv",wdOA,wdOA_output))#save estimates
write_csv(AECis,sprintf("%s/%s/02_Sutherland_2020/22_AE_ebres_multivariate_Sutherland2020_CI.csv",wdOA,wdOA_output))#save ci
write_csv(mul_r,sprintf("%s/%s/02_Sutherland_2020/22_AE_ebres_multivariate_Sutherland2020_rArE.csv",wdOA,wdOA_output))#save correlations