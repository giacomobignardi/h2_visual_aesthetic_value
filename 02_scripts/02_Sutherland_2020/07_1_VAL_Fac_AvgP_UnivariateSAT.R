...
#
#
#Description: repeat procedure in highlighted in 01_Germine_2015/07_Fac_eb_UnivariateSAT_PCA.R
...
# SAVE----------------------------------------------------------------------------------------------------------------------
save(fitSAT,fitCOVsex,fitCOVsex,fitEMO,fitEMO,fitEMVO,fitEMVZ, file = sprintf("%s/%s/02_Sutherland_2020/07_1_SAT_eb_faces_Sutherland2020.RData",wdOA,wdOA_output))
save(modelComparison,file = sprintf("%s/%s/02_Sutherland_2020/07_1_SAT_eb_faces_modelComparison_val.RData",wdOA,wdOA_output))
write_csv(fitSATdescriptives,sprintf("%s/%s/02_Sutherland_2020/07_1_SAT_eb_faces_parameters_val.csv",wdOA,wdOA_output))
write_csv(modelComparison,sprintf("%s/%s/02_Sutherland_2020/07_1_SAT_eb_faces_modelComparison_val.csv",wdOA,wdOA_output))
