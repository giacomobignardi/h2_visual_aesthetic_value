...
#
#
#Description: repeat procedure in highlighted in 01_Germine_2015/08_2_Sce_mm2_UnivariateSAT.R
...
vars <- 'mm2_z_SC' # list of variables names
...
# SAVE----------------------------------------------------------------------------------------------------------------------
save(fitSAT,fitCOVsex,fitCOVsex,fitEMO,fitEMO,fitEMVO,fitEMVZ, file = sprintf("%s/%s/02_Sutherland_2020/08_2_SAT_tt_scenes_Sutherland2020.RData",wdOA,wdOA_output))
save(modelComparison,file = sprintf("%s/%s/02_Sutherland_2020/08_2_SAT_tt_scenes_modelComparison.RData",wdOA,wdOA_output))
write_csv(fitSATdescriptives,sprintf("%s/%s/02_Sutherland_2020/08_2_SAT_tt_scenes_parameters.csv",wdOA,wdOA_output))
write_csv(modelComparison,sprintf("%s/%s/02_Sutherland_2020/08_2_SAT_tt_scenes_modelComparison.csv",wdOA,wdOA_output))
