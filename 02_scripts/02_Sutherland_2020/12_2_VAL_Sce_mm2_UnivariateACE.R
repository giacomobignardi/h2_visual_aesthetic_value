...
load(sprintf("%s/%s/02_Sutherland_2020/08_2_SAT_tt_scenes_Sutherland2020.Rdata", wdOA,wdOA_output))
#compare models
...
fitEstCis(fitACE)
# SAVE----------------------------------------------------------------------------------------------------------------------
save(fitACE,fitCE,fitAE,fitE, file = sprintf("%s/%s/02_Sutherland_2020/12_2_ACE_tt_scenes_Sutherland2020.Rdata",wdOA,wdOA_output))
write_csv(cbind(modelComparison,ACEvc),sprintf("%s/%s/02_Sutherland_2020/12_2_ACE_tt_scenes_vc_modelComparison_val.csv",wdOA,wdOA_output))
write_csv(as.data.frame(AECIests),sprintf("%s/%s/02_Sutherland_2020/12_2_ACE_tt_scenes_vc_bestModel_val.csv",wdOA,wdOA_output))
