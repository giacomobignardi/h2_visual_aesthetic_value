...
Sec_BioMetric_Pheno = BioMetric_Pheno%>%
...
mzData <- subset(Sec_BioMetric_Pheno, TwinType==1, c(selVars, covVars))
dzData <- subset(Sec_BioMetric_Pheno, TwinType==3, c(selVars, covVars))
...
load(sprintf("%s/%s/02_Sutherland_2020/09_2_SAT_ebres_scenes_Sutherland2020.Rdata", wdOA,wdOA_output))
#compare models
...
#Best model VCAest
# SAVE----------------------------------------------------------------------------------------------------------------------
save(fitACE,fitAE,fitCE,fitE, file = sprintf("%s/%s/02_Sutherland_2020/13_2_ADE_ebres_scenes_Sutherland2020.Rdata",wdOA,wdOA_output))
write_csv(cbind(modelComparison,ACEvc),sprintf("%s/%s/02_Sutherland_2020/13_2_ADE_ebres_scenes_vc_modelComparison_val.csv",wdOA,wdOA_output))
write_csv(as.data.frame(AECIests),sprintf("%s/%s/02_Sutherland_2020/13_2_ADE_ebres_scenes_vc_bestModel_val.csv",wdOA,wdOA_output))
