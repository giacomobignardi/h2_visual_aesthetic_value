...
load(sprintf("%s/%s/02_Sutherland_2020/08_1_SAT_tt_faces_Sutherland2020.Rdata", wdOA,wdOA_output))
#compare models
...
fitEstCis(fitADE)
# SAVE----------------------------------------------------------------------------------------------------------------------
save(fitADE,fitAE,fitE, file = sprintf("%s/%s/02_Sutherland_2020/12_1_ADE_tt_faces_Sutherland2020.Rdata",wdOA,wdOA_output))
write_csv(cbind(modelComparison,ADEvc),sprintf("%s/%s/02_Sutherland_2020/12_1_ADE_tt_faces_vc_modelComparison_val.csv",wdOA,wdOA_output))
write_csv(as.data.frame(AECIests),sprintf("%s/%s/02_Sutherland_2020/12_1_ADE_tt_faces_vc_bestModel_val.csv",wdOA,wdOA_output))
