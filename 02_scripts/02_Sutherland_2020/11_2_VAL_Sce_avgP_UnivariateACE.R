...
load(sprintf("%s/%s/02_Sutherland_2020/07_2_SAT_eb_scenes_Sutherland2020.Rdata", wdOA,wdOA_output))
#compare models
...
#Best model VCAest
# SAVE----------------------------------------------------------------------------------------------------------------------
save(fitACE,fitAE,fitCE,fitE, file = sprintf("%s/%s/02_Sutherland_2020/11_2_ADE_eb_scenes_Sutherland2020.Rdata",wdOA,wdOA_output))
write_csv(cbind(modelComparison,ACEvc),sprintf("%s/%s/02_Sutherland_2020/11_2_ADE_eb_scenes_vc_modelComparison_val.csv",wdOA,wdOA_output))
write_csv(as.data.frame(AECIests),sprintf("%s/%s/02_Sutherland_2020/11_2_ADE_eb_scenes_vc_bestModel_val.csv",wdOA,wdOA_output))
