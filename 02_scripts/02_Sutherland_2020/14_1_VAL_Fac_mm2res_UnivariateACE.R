...
# ----------------------------------------------------------------------------------------------------------------------
vars <- 'mm2_z_FAres' # list of variables names
...
# Set Starting Values
svBeAge <- -0.001 # start value for regressions
...
load(sprintf("%s/%s/02_Sutherland_2020/10_1_SAT_ttres_faces_Sutherland2020.Rdata", wdOA,wdOA_output))
#compare models
...
# SAVE----------------------------------------------------------------------------------------------------------------------
save(fitADE,fitAE,fitE, file = sprintf("%s/%s/02_Sutherland_2020/14_1_ADE_ttres_faces_Sutherland2020.Rdata",wdOA,wdOA_output))
write_csv(cbind(modelComparison,ADEvc),sprintf("%s/%s/02_Sutherland_2020/14_1_ADE_ttres_faces_vc_modelComparison_val.csv",wdOA,wdOA_output))
write_csv(as.data.frame(AECIests),sprintf("%s/%s/02_Sutherland_2020/14_1_ADE_ttres_faces_vc_bestModel_val.csv",wdOA,wdOA_output))
