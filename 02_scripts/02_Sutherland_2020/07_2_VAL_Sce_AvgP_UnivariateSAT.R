...
#
#
#Description: repeat procedure in highlighted in 01_Germine_2015/07_2_Sce_eb_UnivariateSAT_PCA.R
...
vars <- 'avgP_SC' # list of variables names
...
# SAVE----------------------------------------------------------------------------------------------------------------------
save(fitSAT,fitCOVsex,fitCOVsex,fitEMO,fitEMO,fitEMVO,fitEMVZ, file = sprintf("%s/%s/02_Sutherland_2020/07_2_SAT_eb_scenes_Sutherland2020.RData",wdOA,wdOA_output))
save(modelComparison,file = sprintf("%s/%s/02_Sutherland_2020/07_2_SAT_eb_scenes_modelComparison_val.RData",wdOA,wdOA_output))
write_csv(fitSATdescriptives,sprintf("%s/%s/02_Sutherland_2020/07_2_SAT_eb_scenes_parameters_val.csv",wdOA,wdOA_output))
write_csv(modelComparison,sprintf("%s/%s/02_Sutherland_2020/07_2_SAT_eb_scenes_modelComparison_val.csv",wdOA,wdOA_output))
