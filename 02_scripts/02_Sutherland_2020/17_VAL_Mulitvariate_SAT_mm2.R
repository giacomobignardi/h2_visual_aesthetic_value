...
####SAVE####
save(fitSAT, file = sprintf("%s/%s/02_Sutherland_2020/17_SAT_tt_multivariate_Sutherland2020.RData",wdOA,wdOA_output))
write_csv(MZcovCor%>%rownames_to_column(),sprintf("%s/%s/02_Sutherland_2020/17_SAT_tt_MZcorMatrix_multivariate_Sutherland2020.csv",wdOA,wdOA_output))
write_csv(DZcovCor%>%rownames_to_column(),sprintf("%s/%s/02_Sutherland_2020/17_SAT_tt_DZcorMatrix_multivariate_Sutherland2020.csv",wdOA,wdOA_output))
