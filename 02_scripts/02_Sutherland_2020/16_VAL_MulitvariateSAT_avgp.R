...
####SAVE####
save(fitSAT, file = sprintf("%s/%s/02_Sutherland_2020/16_SAT_eb_multivariate_Sutherland2020.RData",wdOA,wdOA_output))
write_csv(MZcovCor%>%rownames_to_column(),sprintf("%s/%s/02_Sutherland_2020/16_SAT_eb_MZcorMatrix_multivariate_Sutherland2020.csv",wdOA,wdOA_output))
write_csv(DZcovCor%>%rownames_to_column(),sprintf("%s/%s/02_Sutherland_2020/16_SAT_eb_DZcorMatrix_multivariate_Sutherland2020.csv",wdOA,wdOA_output))
