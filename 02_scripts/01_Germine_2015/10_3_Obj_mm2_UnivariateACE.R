...
load(sprintf("%s/%s/01_Germine_2015/08_3_SAT_tt_abstracts_Germine2015.RData", wdOA,wdOA_output))
#compare models
...
#Best model VCAest
CECIests = fitEstCis(fitCE)
fitEstCis(fitACE)

# SAVE----------------------------------------------------------------------------------------------------------------------
save(fitACE,fitAE,fitCE,fitE, file = sprintf("%s/%s/01_Germine_2015/10_3_ACE_tt_abstracts_Germine2015.RData",wdOA,wdOA_output))
write_csv(cbind(modelComparison,ACEvc),sprintf("%s/%s/01_Germine_2015/10_3_ACE_tt_abstracts_vc_modelComparsion.csv",wdOA,wdOA_output))
write_csv(as.data.frame(CECIests),sprintf("%s/%s/01_Germine_2015/10_3_ACE_tt_abstracts_vc_bestModel.csv",wdOA,wdOA_output))
