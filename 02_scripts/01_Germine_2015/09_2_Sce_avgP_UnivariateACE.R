...
#load dataFrames:
load(sprintf("%s/%s/01_Germine_2015/07_2_SAT_eb_scenes_Germine2015.RData", wdOA,wdOA_output))
#compare models
...
fitEstCis(fitACE)
# SAVE----------------------------------------------------------------------------------------------------------------------
save(fitACE,fitAE,fitCE,fitE, file = sprintf("%s/%s/01_Germine_2015/09_2_ACE_eb_scenes_Germine2015.RData",wdOA,wdOA_output))
write_csv(cbind(modelComparison,ACEvc),sprintf("%s/%s/01_Germine_2015/09_2_ACE_eb_scenes_vc_modelComparison.csv",wdOA,wdOA_output))
write_csv(as.data.frame(AECIests),sprintf("%s/%s/01_Germine_2015/09_2_ACE_eb_scenes_vc_bestModel.csv",wdOA,wdOA_output))
