...
library(psych)
library(readr)
#note here we are switching the CSOLNP optimizer, as we had trouble computing confidence intervals
#for the genetic correlation with the SLSQP optimizer. in 13_1.2_ we show that running SLSQP gives identical estimates
...
####SAVE###
save(fitAE, file = sprintf("%s/%s/01_Germine_2015/13_1_AE_eb_multivariate_Germine2015.RData",wdOA,wdOA_output))#save output
write_csv(modelComparison,sprintf("%s/%s/01_Germine_2015/13_1_AE_eb_multivariate_modelComparison.csv",wdOA,wdOA_output))#save model comparison
write_csv(AEvc,sprintf("%s/%s/01_Germine_2015/13_1_AE_eb_multivariate_h2.csv",wdOA,wdOA_output))#save estimates
write_csv(AECis,sprintf("%s/%s/01_Germine_2015/13_1_AE_eb_multivariate_CI.csv",wdOA,wdOA_output))#save ci
write_csv(mul_r,sprintf("%s/%s/01_Germine_2015/13_1_AE_eb_multivariate_rArE.csv",wdOA,wdOA_output))#save correlations
