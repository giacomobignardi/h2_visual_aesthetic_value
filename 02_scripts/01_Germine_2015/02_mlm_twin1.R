...
#
#
#Description: Variance Component Analysis (VCA) via Multi-Level Modeling (mlm)
# compute Variance Partitioning Components (VPCs) per domain
# as supplement compute modified Beholder Indexes
#Program: 02_mlm_twin1 ------------------------------------------------------------------------------------------------------------------------------
...
#load dataFrames:
Fac_MLM_TwinLong  = read_csv(sprintf("%s/%s/01_Germine_2015/01_MLM_Fac_Twin1_Germine2015.csv", wdOA,wdOA_output))
Sce_MLM_TwinLong  = read_csv(sprintf("%s/%s/01_Germine_2015/01_MLM_Sce_Twin1_Germine2015.csv", wdOA,wdOA_output))
Obj_MLM_TwinLong  = read_csv(sprintf("%s/%s/01_Germine_2015/01_MLM_Obj_Twin1_Germine2015.csv", wdOA,wdOA_output))
...
####_abstracts####
#calculate repetable and error variance
...
write_csv(VCAsummary,sprintf("%s/%s/01_Germine_2015/02_VCA_twin1_Germine2015.csv",wdOA,wdOA_output))
save(MLMsummary, file = sprintf("%s/%s/01_Germine_2015/02_MLM_twin1_Germine2015.RData",wdOA,wdOA_output))