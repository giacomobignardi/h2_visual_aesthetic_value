...
# Set Starting Values 
svMe      <- c(6,5,4)        # start value for means
...
####SAVE####
save(fitSAT, file = sprintf("%s/%s/01_Germine_2015/12_1_SAT_eb_multivariate_Germine2015.RData",wdOA,wdOA_output))
write_csv(MZcovCor%>%rownames_to_column(),sprintf("%s/%s/01_Germine_2015/12_1_SAT_eb_MZcorMatrix_multivariate.csv",wdOA,wdOA_output))
write_csv(DZcovCor%>%rownames_to_column(),sprintf("%s/%s/01_Germine_2015/12_1_SAT_eb_DZcorMatrix_multivariate.csv",wdOA,wdOA_output))
