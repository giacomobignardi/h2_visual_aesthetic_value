...
#load dataFrames:
load(sprintf("%s/%s/01_Germine_2015/07_1_SAT_eb_faces_Germine2015.RData", wdOA,wdOA_output))
#compare models
...
fitEstCis(fitACE)
# SAVE----------------------------------------------------------------------------------------------------------------------
save(fitACE,fitAE,fitCE,fitE, file = sprintf("%s/%s/01_Germine_2015/09_1_ACE_eb_faces_Germine2015.RData",wdOA,wdOA_output))
write_csv(cbind(modelComparison,ACEvc),sprintf("%s/%s/01_Germine_2015/09_1_ACE_eb_faces_vc_modelComparison.csv",wdOA,wdOA_output))
write_csv(as.data.frame(AECIests),sprintf("%s/%s/01_Germine_2015/09_1_ACE_eb_faces_vc_bestModel.csv",wdOA,wdOA_output))
